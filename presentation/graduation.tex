...
%		
	...
	\begin{frame}
		\frametitle{Часть 2. Аппроксимация индекса неоднородности}
		{\color{blue} Ряд:}
		$ F_N=(f_1, \dots, f_{N}) $, где $f_n = 
		\begin{cases}
			C_1\sin(2\pi\omega_1n + \phi_1),& n < Q, \\
	...
	\begin{frame}
		\frametitle{Часть 2. Аппроксимация индекса однородности: точность аппроксимации}
	...
	\begin{frame}
		\frametitle{Часть 3. Оценка системы: параметр $ T $}
		\begin{figure}[!hhh]
	...
	\begin{frame}
		\frametitle{Часть 3. Оценка системы: параметр $ B $}
		\begin{figure}[!hhh]
